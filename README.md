...
|---|---|---|
| ⚾ [MLB The Show 24 Dashboard](https://github.com/katiehuangx/Maven-Unicorn-Challenge) | Cleansed and transformed data on Playstation baseball game MLB the Show 24. Bought and extracted data into Tableau from third-party website. Generated three workbooks with interesting baseball player insights in the game. Findings can help people choose the best players in the game.  | [DASHBOARD LINK 1](https://public.tableau.com/app/profile/randy.leon5673/viz/MLBTheShow24Dashboard/Dashboard1?publish=yes) |
